...
if ($should_print_google) {
            $this->lr_print_google_button($gclient, $lr, $gbtn_text, $form_type);
        }
            if ($should_print_fb) {
     ...
     */
    public function lr_print_google_button($client_id, $lr, $btn_text = '', $form_type = 'login')
    {
        $form_type = in_array($form_type, ['login', 'register']) ? $form_type : 'login';
        ?>
        <div class="eael-social-button eael-google"
             id="eael-google-<?php echo esc_attr($form_type); ?>-btn-<?php echo esc_attr($lr->get_id()); ?>"
